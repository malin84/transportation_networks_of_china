...
The list of published academic papers that used this dataset is [here](https://github.com/malin84/transportation_networks_of_china/blob/main/Papers_Using_This_Dataset.md). To use the data, please cite:
