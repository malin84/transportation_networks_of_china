...
The file `pref_pair/cityinfo.csv` contains basic information about the 279 prefectures in the prefecture-to-prefecture travel time dataset. The columns are as follows:
...
9. `cpop2000`: total population (in ten thousands), 2000 census.
10. `cpop2010`: total population (in ten thousands), 2010 census.
11. `upop2000`: urban population (in ten thousands), 2000 census.
12. `upop2010`: urban population (in ten thousands), 2010 census.
